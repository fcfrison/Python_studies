'''
In the code below, follows the implementation of Query Parameters.
...
if __name__=="__main__":
    import uvicorn
    uvicorn.run("main_lecture_18:app", host="localhost", # uvicorn is a server for assynchronous processing
