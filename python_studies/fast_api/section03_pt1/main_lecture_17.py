'''
In the code below, follows the implementation of Path Parameters.
The point of using this tool is to restrict the parameters passed
by the client.
...
if __name__=="__main__":
    import uvicorn
    uvicorn.run("main_lecture_17:app", host="localhost", # uvicorn is a server for assynchronous processing
