'''
It's possible to improve the GUI (for instance, localhost:8000/docs).
...
app = FastAPI(
    title='Incredible test - API',
    version='0.0.1',
    description='API for studying FastAPI.')
...
# Dependencies here !!!!!!
@app.get("/courses",
         description='Returns the courses registered on the database.', # Adding a description to the GUI
         summary='Returns all courses.',
         response_model=Dict[int,Course]) # Adding an example of what will be returned.
...
if __name__=="__main__":
    import uvicorn
    uvicorn.run("main_lecture_21:app", host="localhost", # uvicorn is a server for assynchronous processing
