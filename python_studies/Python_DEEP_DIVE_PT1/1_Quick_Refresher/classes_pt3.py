# Forma pytohnica de implementar getters e setters.
class Retangulo:
    '''
    Cria a classe retângulo.
    '''
    def __init__(self,lado, altura):
        # Os atributos _lado e _altura são, por convenção, colocados como 
        # variáveis privadas (que não devem ser modificadas).
        self._lado = lado
        self._altura = altura
